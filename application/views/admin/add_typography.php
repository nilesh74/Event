	...
	<div class="content-wrapper">
		<section class="content-header">
			...
			<ol class="breadcrumb">
				...
				<li class="active">Add Typography</li>
			</ol>
        </section>
		...
		<section class="content">
			<div class="row">
				<div class="col-lg-12 col-xs-12">
					<form method="post" action="<?php echo base_url(); ?>admin/manage_typography/add_typography" class="form-horizontal form_block_all_page" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" id="fname" name="fname" placeholder="First Name // accepts only letters" value="<?php echo set_value('fname'); ?>">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" id="fullname" name="fullname" placeholder="Full Name // accepts only letters and space" value="<?php echo set_value('fullname'); ?>">
								<div class="clearfix"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" id="contact" name="contact" placeholder="Contact Number // only number //min length 9 // max length 12" value="<?php echo set_value('contact'); ?>">
								<div class="clearfix"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" id="already_exist" name="already_exist" placeholder="Already exist // check whether entry is already exist or not" value="<?php echo set_value('already_exist'); ?>">
								<div class="clearfix"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<select id="select_dropdown" name="select_dropdown" class="form-control">
									...
									<option value="1" <?php echo set_select('select_dropdown',1); ?>>one</option>
									<option value="2" <?php echo set_select('select_dropdown',2); ?>>Two</option>
									<option value="3" <?php echo set_select('select_dropdown',3); ?>>Three</option>
									<option value="4" <?php echo set_select('select_dropdown',4); ?>>Four</option>
									<option value="5" <?php echo set_select('select_dropdown',5); ?>>Five</option>
								</select>
								<div class="clearfix"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<textarea id="editor1" name="editor1" rows="10" cols="80"><?php echo set_value('editor1'); ?></textarea>
								<div class="clearfix"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="only_datepicker" readonly class="form-control"  id="only_datepicker" name="only_datepicker" placeholder="Datepicker" value="<?php echo set_value('only_datepicker'); ?>" />
								<div class="clearfix"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" readonly class="form-control" id="date_timepicker_start" name="date_timepicker_start" placeholder="Start Date" value="<?php echo set_value('date_timepicker_start'); ?>">
								<div class="clearfix"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" readonly class="form-control" id="date_timepicker_end" name="date_timepicker_end" placeholder="End Date" value="<?php echo set_value('date_timepicker_end'); ?>">
								<div class="clearfix"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" readonly  class="form-control" id="time_timepicker" name="time_timepicker" placeholder="Time" value="<?php echo set_value('time_timepicker'); ?>">
								<div class="clearfix"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="checkbox">
									<label>
									  <input type="checkbox" name="accept_terms" value="1" <?php echo set_checkbox('accept_terms', '1'); ?>>
									</label>
								</div>
								<div class="clearfix"></div>
						...
						<div class="form-group">
							<div class="col-sm-offset-3 col-sm-10">
								<button type="submit" class="btn  btn-flat btn-success">Add Typography</button>
							</div>
						</div>
					</form> 
				</div>
